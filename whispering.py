...
bound_cond = 3  #Boundary cond 1 : Dirichlet, 2 : Neumann, 3 Mur
...
L_t = 10 #Duration of simulation [s]
...
#surf2 = ax.plot_surface(SX, SY, U[:,:,1000],cmap = plt.cm.viridis)
...
#mesh = plt.pcolor(SX, SY, U[:,:,500])
#plt.colorbar(mesh, orientation = "vertical")
#plt.savefig('4fuentesdiffase500.pdf')
